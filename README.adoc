...
[source,sh]
----
java -Xss5m -Xmx2048m -jar target/mn2pdf-2.05.jar --xml-file <XML-FileName> --xsl-file <XSLT-FileName> --pdf-file <Output-PDF-FileName> [--syntax-highlight]
----
...
[source,sh]
----
java -Xss5m -Xmx2048m -jar target/mn2pdf-2.05.jar --xml-file tests/G.191.xml --xsl-file tests/itu.recommendation.xsl --pdf-file tests/G.191.pdf
----
