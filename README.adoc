...
[source,sh]
----
java -Xss5m -Xmx1024m -jar target/mn2pdf-1.27.jar --xml-file <XML-FileName> --xsl-file <XSLT-FileName> --pdf-file <Output-PDF-FileName>
----
...
[source,sh]
----
java -Xss5m -Xmx1024m -jar target/mn2pdf-1.27.jar --xml-file tests/G.191.xml --xsl-file tests/itu.recommendation.xsl --pdf-file tests/G.191.pdf
----
