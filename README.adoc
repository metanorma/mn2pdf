...
[source,sh]
----
java -Xss5m -Xmx2048m -Djdk.xml.maxGeneralEntitySizeLimit=0 -Djdk.xml.totalEntitySizeLimit=0 -jar target/mn2pdf-2.72.jar --xml-file <XML-FileName> --xsl-file <XSLT-FileName> --pdf-file <Output-PDF-FileName>
----
...
[source,sh]
----
java -Xss5m -Xmx2048m -Djdk.xml.maxGeneralEntitySizeLimit=0 -Djdk.xml.totalEntitySizeLimit=0 -jar target/mn2pdf-2.72.jar --xml-file tests/G.191.xml --xsl-file tests/itu.recommendation.xsl --pdf-file tests/G.191.pdf
----
...
=== Certify the PDF feature

|===
|parameter | description

|--keystore <file name> | keystore file with certificate
