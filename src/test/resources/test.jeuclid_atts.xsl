...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:mn="https://www.metanorma.org/ns/standoc" xmlns:mnx="https://www.metanorma.org/ns/xslt" xmlns:mathml="http://www.w3.org/1998/Math/MathML" xmlns:xalan="http://xml.apache.org/xalan" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions" xmlns:pdf="http://xmlgraphics.apache.org/fop/extensions/pdf" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:java="http://xml.apache.org/xalan/java" xmlns:barcode="http://barcode4j.krysalis.org/ns" xmlns:redirect="http://xml.apache.org/xalan/redirect" exclude-result-prefixes="java" extension-element-prefixes="redirect" version="1.0">
	...
	<xsl:template match="/">
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:barcode="http://barcode4j.krysalis.org/ns" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:pdf="http://xmlgraphics.apache.org/fop/extensions/pdf" xmlns:fox="http://xmlgraphics.apache.org/fop/extensions" xmlns:xalan="http://xml.apache.org/xalan" xmlns:mathml="http://www.w3.org/1998/Math/MathML" xmlns:mnx="https://www.metanorma.org/ns/xslt" xmlns:mn="https://www.metanorma.org/ns/standoc" xmlns:jeuclid="http://jeuclid.sf.net/ns/ext" xml:lang="en" font-family="Cambria, Times New Roman, Cambria Math" font-size="11pt">
		...
		<fo:inline font-family="Cambria Math">
			<fo:instream-foreign-object fox:alt-text="Math" fox:actual-text="Math">
				<xsl:copy>
					...
					<xsl:attribute name="scriptSizeMult" namespace="http://jeuclid.sf.net/ns/ext">2</xsl:attribute>
